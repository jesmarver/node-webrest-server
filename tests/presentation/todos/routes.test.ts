...
describe('Todo route settings', () => {
    ...
    test('should return an error if text is not present api/todos', async () => {
        ...
        expect(body).toEqual({ error: 'Text propertie is required' });
    ...
    test('should return an updated TODO api/todos/:id', async () => {
        ...
        const { body } = await request(testServer.app)
            ...
            .send({ text: 'Hola mundo UPDATE', completedAt: '2025-10-21' })
            .expect(200);
    ...
    test('should delete a TODO api/todos/:id', async () => {
        ...
        expect(body).toEqual({ id: todo.id, text: todo1.text });
    });
